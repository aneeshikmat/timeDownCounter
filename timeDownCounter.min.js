...
return}
document.getElementById(countDownIdSelector).innerHTML=countDownReturnDataResult;if(distance<0){clearInterval(start);document.getElementById(countDownIdSelector).innerHTML=contDownOver}},1000)}}}